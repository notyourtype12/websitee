...
Project ini juga dikembangkan sebagai bagian dari **portfolio developer** dan implementasi pembelajaran dalam membangun **Sistem Informasi Desa berbasis PHP Native dan MySQL**.
...
| Bootstrap | Framework UI untuk tampilan responsif |
...
### 3. Pindahkan project ke folder server

Jika menggunakan **XAMPP**, pindahkan project ke folder:
...
```
C:\xampp\htdocs\digital-village
```
...
3. Import file database `.sql` yang tersedia pada project.
...
Lalu sesuaikan dengan konfigurasi database lokal:
...
- Mengembangkan keterampilan dalam pengembangan aplikasi web menggunakan PHP Native
